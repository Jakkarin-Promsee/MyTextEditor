...
const SlateToolbar = ({ isPreview, setIsPreview }: Props) => {
  return (
    <>
      <div className="flex items-center justify-between px-2 py-2 mb-2 border rounded-lg border-gray-200 dark:border-gray-700 bg-gray-50  dark:bg-gray-900 text-gray-900 dark:text-gray-50 shadow-sm">
